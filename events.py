...
from Takagi_sanRobot import MONGO_DB_URI
from Takagi_sanRobot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"Takagi_sanRobot/modules/{shortname}.py")
        name = "Takagi_sanRobot.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Takagi_sanRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Takagi_sanRobot/modules/*.py"
