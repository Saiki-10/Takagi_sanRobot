...
import Takagi_sanRobot.modules.sql.blacklist_sql as sql
from Takagi_sanRobot import dispatcher, LOGGER
from Takagi_sanRobot.modules.disable import DisableAbleCommandHandler
from Takagi_sanRobot.modules.helper_funcs.chat_status import user_admin, user_not_admin
from Takagi_sanRobot.modules.helper_funcs.extraction import extract_text
from Takagi_sanRobot.modules.helper_funcs.misc import split_message
from Takagi_sanRobot.modules.log_channel import loggable
from Takagi_sanRobot.modules.warns import warn
from Takagi_sanRobot.modules.helper_funcs.string_handling import extract_time
from Takagi_sanRobot.modules.connection import connected
from Takagi_sanRobot.modules.sql.approve_sql import is_approved
from Takagi_sanRobot.modules.helper_funcs.alternate import send_message, typing_action
...
Examples of time value: 1m = 1 minutes, 3h = 3 hours, 4d = 4 days, 7w = 7 weeks."""
                send_message(update.effective_message, teks, parse_mode="markdown")
                return ""
            restime = extract_time(msg, args[1])
            if not restime:
                teks = """Invalid time value!
Example of time value: 1m = 1 minutes, 3h = 3 hours, 4d = 4 days, 7w = 7 weeks."""
                send_message(update.effective_message, teks, parse_mode="markdown")
                return ""
