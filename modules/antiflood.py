...
from Takagi_sanRobot import TIGERS, WOLVES, dispatcher
...
from TakagiRobot.modules.log_channel import loggable
from TakagiRobot.modules.sql import antiflood_sql as sql
...
from TakagiRobot.modules.helper_funcs.string_handling import extract_time
from TakagiRobot.modules.connection import connected
from TakagiRobot.modules.helper_funcs.alternate import send_message
from TakagiRobot.modules.sql.approve_sql import is_approved
...
def check_flood(update, context) -> str:
    ...
    try:
        ...
        if getmode == 1:
            ...
            tag = "TMUTE"
        send_message(
            update.effective_message, "Hue Hue Hue!!\n{}!".format(execstrings)
        )
    ...
    if conn:
        ...
        if update.effective_message.chat.type == "private":
            send_message(
                ...
                "This command is usable in group chats not in PM",
            )
            return ""
...
Examples of time value: 1m = 1 minute, 3h = 3 hours, 4d = 4 days, 7w = 7 weeks."""
