...
import Takagi_sanRobot.modules.sql.notes_sql as sql
from Takagi_sanRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Takagi_sanRobot.__main__ import DATA_IMPORT
from Takagi_sanRobot.modules.helper_funcs.chat_status import user_admin
from Takagi_sanRobot.modules.helper_funcs.alternate import typing_action

# from Takagi_sanRobot.modules.rules import get_rules
import Takagi_sanRobot.modules.sql.rules_sql as rulessql

# from Takagi_sanRobot.modules.sql import warns_sql as warnssql
import Takagi_sanRobot.modules.sql.blacklist_sql as blacklistsql
from Takagi_sanRobot.modules.sql import disable_sql as disabledsql

# from Takagi_sanRobot.modules.sql import cust_filters_sql as filtersql
# import Takagi_sanRobot.modules.sql.welcome_sql as welcsql
import Takagi_sanRobot.modules.sql.locks_sql as locksql
from Takagi_sanRobot.modules.connection import connected
...
def import_data(update, context):
    ...
    if conn:
        ...
        if update.effective_message.chat.type == "private":
            update.effective_message.reply_text("This command is only available for group!")
            return ""
