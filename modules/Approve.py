...
from Takagi_sanRobot import dispatcher, DRAGONS
from Takagi_sanRobot.modules.helper_funcs.extraction import extract_user
from telegram.ext import CallbackContext, run_async, CallbackQueryHandler
import Takagi_sanRobot.modules.sql.approve_sql as sql
...
def approve(update, context):
    ...
    if not user_id:
        message.reply_text(
            "Dear sir! You need to specify a user! And I don't think that this is a user."
        )
        return ""
    try:
