...
import Takagi_sanRobot.modules.sql.locks_sql as sql
from Takagi_sanRobot import dispatcher, DRAGONS, LOGGER
    ...
    if (
        ...
        if len(args) >= 1:
            ...
            if ltype in LOCK_TYPES:
                ...
                if conn:
                    ...
                    if update.effective_message.chat.type == "private":
                        send_message(
                            ...
                            "This command is usable in group chats, not in PM, sorry!!",
                        )
                        return ""
                    chat = update.effective_chat
                ...
                send_message(
                    update.effective_message,
                    "Can't understand what you want to do. Try /locktypes for the list of lockables",
                )
        else:
