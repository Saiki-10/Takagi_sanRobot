...
import Takagi_sanRobot.modules.sql.welcome_sql as sql
import Takagi_sanRobot
...
from Takagi_sanRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Takagi_sanRobot.modules.helper_funcs.msg_types import get_welcome_type
from Takagi_sanRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Takagi_sanRobot.modules.log_channel import loggable
from Takagi_sanRobot.modules.sql.global_bans_sql import is_user_gbanned
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Nishikita-san! I missed you..", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Be cool! A member of the Takagi-sanSupport just joined.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome yourself
                ...
                creator = None
                if not Takagi_sanRobot.ALLOW_CHATS:
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "See you later at the Takagi_sanSupport!",
                    reply_to_message_id=reply,
                )
                return
