...
import Takagi_sanRobot.modules.sql.blsticker_sql as sql
from Takagi_sanRobot import LOGGER, dispatcher
        ...
        if args[0].lower() in ["off", "nothing", "no"]:
            ...
            if len(args) == 1:
                teks = """It looks like you are trying to set a temporary value to blacklist, but has not determined the time; use `/blstickermode tban <timevalue>`.
                                          Examples of time values: 1m = 1 minute, 3h = 3 hours, 4d = 4 days, 7w = 7 weeks."""
