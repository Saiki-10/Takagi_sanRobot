...
from Takagi_sanRobot.modules.helper_funcs.msg_types import Types
from Takagi_sanRobot.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Ready player {first}",
    "Nisikata, {first} is here.", #Teasing master takagi-san
    "A wild {first} appeared.", #Pokemon
    "{first} came in like a Lion!",
    "{first} has joined your party.", #konosuba
    "{first} just joined. Can I get a heal?",
    "{first} just joined the chat - Pawry!!",
    ...
    "{first} joined the group, read by Mark Zuckerberg, CIA and 69 others.",
    "Welcome {first}, watch out for falling monkeys.",
    "Everyone stop what you’re doing, We are now in the presence of {first}.",
    "Hey {first}, do you wanna know how I got these scars?", #the dark night (Joker)
    ...
    "Data of {first} has been added into pokedex", #pokemon
    ...
    "Zyjacya in love (forever in love)", #Nisekoi
...
DEFAULT_GOODBYE_MESSAGES = [
    ...
    "Marry and reproduce",
    "Stay asleep",
    "Yare-Yare", #Saiki kusou no psi-nan
